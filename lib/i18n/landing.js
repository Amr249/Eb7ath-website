...
export function landingDict(lang, expertsByLocale = { ar: [], en: [] }) {
  const en = {
    ...
    oppsHead: {
      ...
      view: "View profile",
      viewAll: "View all consultants",
    },
    projects: expertsByLocale.en ?? [],
    blogHome: {
      eyebrow: "Blog",
  ...
  const ar = {
    ...
    hero: {
      ...
      sub: "بين ضغط المناوبات السريرية ومعايير الهيئة السعودية للتخصصات الصحية، تقف «اِبْحَثْ» كشريكك الأكاديمي الموثوق؛ لتُمكّنك منهجياً وتُجنّبك خطر مسارات النشر غير المعتمدة.",
    },
    stats: {
      ...
      v1: "١٢+",
      l1: "استشاري وأستاذ جامعي متعاون ",
      v2: "500+",
      l2: "طبيب حققوا الزمالات الأجنبية و البورد السعودي عبر منصتنا ",
      v3: "١٥+",
    ...
    story: {
      eyebrow: "قصتنا",
      h2: "بُني «اِبْحَثْ» بأيدي أطباء ولأجل الأطباء",
    ...
    services: [
      { eyebrow: "التحليل", title: "التحليل الإحصائي الطبي", body: "نتائج دقيقة ببرامج متقدمة (SPSS/R) تتوافق تماماً مع اشتراطات المجلات العالمية.", learn: "تواصل لطلب الخدمة", explore: "استكشف", img: IMAGES.ssrService },
      { eyebrow: "المراجعة", title: "المراجعة المنهجية واللغوية", body: "صياغة أكاديمية رصينة ترفع جودة بحثك وتلبي المعايير الصارمة للمجلات المحكمة.", learn: "تواصل لطلب الخدمة", explore: "استكشف", img: IMAGES.methodologicalReview },
      { eyebrow: "الاستشارة", title: "الاستشارات البحثية", body: "جلسات توجيهية «واحد لواحد» مع خبراء لرسم خارطة طريق لبحثك من الفكرة حتى النشر.", learn: "تواصل لطلب الخدمة", explore: "استكشف", img: IMAGES.researchConsultations },
      { eyebrow: "النشر", title: "المساعدة في النشر العلمي", body: "توجيه استراتيجي لاختيار المجلات المناسبة وإدارة المراسلات مع المجلة باحترافية لتسهيل رحلة النشر.", learn: "تواصل لطلب الخدمة", explore: "استكشف", img: IMAGES.homeResearch1 },
      { eyebrow: "الدعم", title: "الدعم البحثي المفتوح", body: "عالق في منتصف البحث ولا تعرف الخطوة القادمة أو نوع المساعدة التي تحتاجها تحديداً؟ اترك عبء التقييم لنا، تواصل معنا لنفهم العقبات التي تواجهك بشكل خاص، ونقترح لك الحلول المنهجية التي تسد الفجوة في بحثك أياً كانت.", learn: "تواصل لطلب الخدمة", explore: "استكشف", img: IMAGES.homeResearch2 },
    ],
    oppsHead: {
      eyebrow: "الاستشاريين و الخبراء",
      h2: "",
      ...
      view: "عرض الملف",
      viewAll: "عرض جميع الاستشاريين",
    },
    projects: expertsByLocale.ar ?? [],
    blogHome: {
      eyebrow: "المدونة",
    ...
    voicesLeft: [
      ...
      { quote: '"لضيق وقتي مع العيادات والعمليات لم أكن قادراً على إنجاز بحث كامل رغم كثرة الأفكار البحثية من العمل. بعد التعرف على «اِبْحَثْ» تم دمجي مع فرق بحثية وتقديم الدعم اللازم حتى نُشر نصف أفكاري، والنصف الآخر في مرحلة النشر بالمجلات."', name: "استشاري", role: "استشاري", initials: "MH" },
      { quote: 'استطعت تقديم بحثي في مؤتمر محلي و عالمي و كانت ابحث هي من ساعدتني على اختيار المؤتمر إلى التقديم الفعلي في المؤتمر', name: "طالبة", role: "طالبة", initials: "NS" },
    ...
    voicesRight: [
      { quote: '"جعل «اِبْحَثْ» النشر ممكنًا أثناء فترة إقامتي. كان الدعم حقيقيًا، لا مجرد قوالب."', name: "د. أحمد الرشيد", role: "طبيب مقيم، الباطنة", initials: "AR" },
      ...
      { quote: '"احتجت أبحاثًا للترقية، لكن البحث بدا مستحيلًا أثناء الإقامة. حقّقه «اِبْحَثْ»."', name: "د. سامر الدوسري", role: "طبيب، طب الطوارئ", initials: "SD" },
    ...
    cta: { h2: "ارتقِ بمسيرتك المهنية عبر أبحاث علمية رصينة.", lead: "انضم اليوم لأكثر من 5000+ ممارس صحي يثقون في «اِبْحَثْ» لتطوير مسيرتهم المهنية.", signup: "ابدأ رحلتك البحثية الآن" },
