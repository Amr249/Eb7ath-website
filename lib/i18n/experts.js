export function expertsDict(lang) {
  const en = {
    nav: { home: "Home", about: "About us", consultants: "Consultants", blog: "Blog", faq: "FAQ", start: "Start" },
    footer: {
    ...
    research: {
      ...
      correspondingBadge: "Eb7ath institution expert",
      viewInstitutionExpertProfile: "View expert profile",
  ...
  const ar = {
    nav: { home: "الرئيسية", about: "من نحن", consultants: "الاستشاريين", blog: "المدونة", faq: "الأسئلة الشائعة", start: "ابدأ" },
    footer: {
    ...
    research: {
      ...
      correspondingBadge: "خبير مؤسسة ابحث",
      viewInstitutionExpertProfile: "شاهد ملف الخبير",
      journalLabel: "المجلة",
