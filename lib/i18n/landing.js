...
export function landingDict(lang) {
  const en = {
    ...
    services: [
      ...
      { eyebrow: "Review", title: "Methodological and linguistic review", body: "Solid academic phrasing that elevates your research quality and meets the strict standards of peer-reviewed journals.", learn: "Learn", explore: "Explore", img: IMAGES.homeFeatures1 },
      { eyebrow: "Consultation", title: "Research consultations", body: "One-on-one guidance sessions with experts to map your research from idea to publication.", learn: "Learn", explore: "Explore", img: IMAGES.servicesFeature },
    ...
    faqHead: { h2: "FAQ", lead: "Find answers to questions about joining research teams, earning co-authorship, and meeting SCFHS requirements.", more: "Have more questions?", contact: "Contact" },
    faqItems: [
  ...
  const ar = {
    ...
    stats: {
      ...
      p: "نبني الثقة من خلال أرقام حقيقية، وشركاء يبرهنون على جودة خدمتنا وسلامة مسارنا الأكاديمي",
      v1: "١٢+",
    ...
    path: {
      ...
      c1cta: "تصفح المشاريع",
      c2title: "ركّز على دراستك ورعاية مرضاك.. ودع التمكين الأكاديمي لنا.",
      c2body: "وقت العيادة أولوية. «إِبحَث» يحوّل فكرتك إلى ورقة علمية رصينة عبر تدقيق المنهجية، التحليل الإحصائي، والتوجيه للنشر في مجلات عالمية مرموقة.",
    ...
    steps: {
      ...
      items: [
        ...
        { title: "الاعتماد النهائي", body: "بمجرد اكتمال الخطة، نتواصل معك لتأكيد مقعدك وإتمام الرسوم المالية." },
        { title: "انطلاق البحث", body: "تبدأ رحلتك المنهجية ضمن الفريق لتحقيق إنجازك العلمي واستحقاقك كمؤلف." },
      ],
    },
    story: {
      eyebrow: "قصتنا",
    ...
    svcHead: {
      ...
      lead: "شرح واضح ومبسّط لخدمات المنصة لمن لديه مشروعه البحثي الخاص، بلغة تركّز على الفائدة التي تحققها، لا على الميزات فقط.",
    },
    services: [
      ...
      { eyebrow: "المراجعة", title: "المراجعة المنهجية واللغوية", body: "صياغة أكاديمية رصينة ترفع جودة بحثك وتلبي المعايير الصارمة للمجلات المحكمة.", learn: "تعرّف", explore: "استكشف", img: IMAGES.homeFeatures1 },
      { eyebrow: "الاستشارة", title: "الاستشارات البحثية", body: "جلسات توجيهية «واحد لواحد» مع خبراء لرسم خارطة طريق لبحثك من الفكرة حتى النشر.", learn: "تعرّف", explore: "استكشف", img: IMAGES.servicesFeature },
      { eyebrow: "النشر", title: "المساعدة في النشر العلمي", body: "توجيه استراتيجي لاختيار المجلات المناسبة وإدارة المراسلات باحترافية لتسهيل رحلة النشر.", learn: "تعرّف", explore: "استكشف", img: IMAGES.homeResearch1 },
    ],
    oppsHead: {
      eyebrow: "خبراؤنا",
    ...
    voicesLeft: [
      { quote: '"فهموا تمامًا ما تطلبه الهيئة. لا تخمين ولا جهد ضائع."', name: "د. فاطمة العتيبي", role: "استشارية، طب الأطفال", initials: "FA" },
      { quote: '"كانت لديّ فكرة البحث لكن لا وقت. تولّى «إِبحَث» الإحصاء ومراجعة الكتابة، واستحققت تأليفي المشترك."', name: "د. محمد الحربي", role: "زميل، طب القلب", initials: "MH" },
      { quote: '"كانت فكرتي متينة لكني لم أعرف كيف أنشرها. أرشدوني في كل خطوة."', name: "د. نور الشمري", role: "طبيبة، النساء والولادة", initials: "NS" },
    ...
    cta: { h2: "ارتقِ بمسيرتك المهنية عبر أبحاث علمية رصينة.", lead: "انضم اليوم لأكثر من 500+ ممارس صحي يثقون في «إِبحَث» لتطوير مسيرتهم المهنية.", signup: "ابدأ رحلتك البحثية الآن" },
    faqHead: { h2: "الأسئلة الشائعة", lead: "اعثر على إجابات حول الانضمام إلى الفرق البحثية، والحصول على التأليف المشترك، واستيفاء متطلبات الهيئة.", more: "لديك المزيد من الأسئلة؟", contact: "تواصل معنا" },
    faqItems: [
