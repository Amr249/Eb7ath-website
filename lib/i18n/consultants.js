export function consultantsDict(lang) {
  const en = {
    ...
    hero: {
      ...
      h1: "Consultants and university professors supervising your research",
    ...
    cta: {
      h2: "Want your research supervised by one of our consultants?",
  ...
  const ar = {
    ...
    hero: {
      eyebrow: "استشاريونا",
      h1: "استشاريون وأساتذة جامعيون يشرفون على أبحاثك",
    ...
    cta: {
      h2: "تريد إشراف أحد استشاريينا على بحثك؟",
