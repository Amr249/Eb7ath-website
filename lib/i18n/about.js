...
export function aboutDict(lang) {
  ...
  const ar = {
    ...
    vmv: {
      ...
      cardBig: {
        ...
        items: [
          ...
          { title: "الشفافية", body: "وضوح تام في المسارات، التكاليف، والمتطلبات منذ اليوم الأول." },
        ],
      },
      sections: [
        {
          ...
          heading: "رسالتنا",
          description:
            "تذليل العقبات المنهجية والزمنية أمام الكفاءات الطبية الوطنية، عبر توفير بيئة بحثية تعاونية تجمع بين صرامة البحث العلمي ومرونة الحلول الرقمية، مع الالتزام المطلق بأعلى معايير النزاهة الأكاديمية.",
        },
        {
          icon: "globe",
          heading: "رؤيتنا",
    ...
    why: {
      ...
      lead: "نقاط قوية تلمس احتياجات الجمهور المستهدف وتُميّزنا عن أي منافس.",
    },
    whyCards: [
      {
