...
export function aboutDict(lang) {
  ...
  const ar = {
    ...
    hero: {
      ...
      sub: "وُجد «اِبْحَثْ» لأن الأطباء السعوديين يستحقون الأفضل. لا اختصارات، ولا مجلات مفترسة، ولا كُتّاب مجهولون.",
      explore: "استكشف",
      learn: "اعرف المزيد",
    },
    vmv: {
    ...
    why: {
      eyebrow: "الميزة",
      h2: "لماذا يختار الأطباء «اِبْحَثْ»",
    },
    whyCards: [
      {
    ...
    cta: { h2: "ابدأ رحلتك البحثية", lead: "تواصل مع «اِبْحَثْ» وابنِ الملف الأكاديمي الذي تتطلبه مسيرتك.", btn: "ابدأ رحلتك البحثية الآن" },
