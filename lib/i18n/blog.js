...
export function blogDict(lang) {
  const en = {
    ...
    feat: { eyebrow: "Featured", h2: "What matters now", lead: "Essential reading for your research journey", readMore: "Read more", empty: "No posts yet. Check back soon." },
  ...
  const ar = {
    ...
    feat: { eyebrow: "مميّز", h2: "ما يهمّ الآن", lead: "قراءات أساسية لرحلتك البحثية", readMore: "اقرأ المزيد", empty: "لا توجد مقالات بعد. عُد قريبًا." },
